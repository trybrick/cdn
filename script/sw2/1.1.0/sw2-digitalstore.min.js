...
(function ($, window, undefined) {
  ...
  $.gsnSw2 = $.fn.gsnSw2 = function (id, options) {
    ...
    var ads = $(options.displayWhenExists || '.gsnunit');

    if (ads.length) {

      ads.each(function(index){

        //if any of the ads is showing, we can do a takeover and so
        // shopper welcome makes sense
      ...
      //if we get here, all the ads are hidden, so cancel
      //to make sure any dfp functions still run
      init(id, selector, options.cancel = true);
    }
